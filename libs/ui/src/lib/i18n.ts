...
const locales = {
  ...
  DATA_IMPORT_AND_EXPORT_TOOLTIP_BASIC: $localize`Switch to Cryptfolio Premium or Cryptfolio Open Source easily`,
  DATA_IMPORT_AND_EXPORT_TOOLTIP_OSS: $localize`Switch to Cryptfolio Premium easily`,
  DATA_IMPORT_AND_EXPORT_TOOLTIP_PREMIUM: $localize`Switch to Cryptfolio Open Source or Cryptfolio Basic easily`,
